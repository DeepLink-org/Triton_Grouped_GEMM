...
def permute(input, indices, num_out_tokens, workspace, max_expanded_token_num, num_negative_one_in_indices=0):
    return backend.permute(input, indices, num_out_tokens, workspace, num_negative_one_in_indices, max_expanded_token_num)
